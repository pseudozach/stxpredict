...
(define-public (createMarket (question (string-ascii 99)) (paypervote uint) (resolver principal) (resolveTime uint) (resolveType (string-ascii 10)))
  (begin
    (map-set marketDatabase {marketId: (incrementMarketId)} {question: question, threshold: 0, balance: u0, paypervote: paypervote, resolver: resolver, yescount: u0, nocount: u0, resolveTime: resolveTime, resolveType: resolveType, resolved: false, result: false})
